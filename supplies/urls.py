...
urlpatterns = [
    ...
    path('city/<int:city_id>/update', views.update_city, name='update-city'),
    path('city/<int:city_id>/delete', views.delete_city, name='delete-city'),
    path('add-new-supply-category', views.addNewCategory, name='add-new-supply-category'),
    path('supply-category/<int:category_id>/update', views.update_supply_category, name='update-supply-category'),
    path('supply-category/<int:category_id>/delete', views.delete_supply_category, name='delete-supply-category'),
