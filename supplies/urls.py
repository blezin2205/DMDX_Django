...
urlpatterns = [
    ...
    path('api/desktop/cart/checkout-options', apiViews.DesktopCartCheckoutOptionsAPIView.as_view()),
    path('api/desktop/cities', apiViews.DesktopCitiesAPIView.as_view()),
    path('api/desktop/places-by-city', apiViews.DesktopPlacesByCityAPIView.as_view()),
    path('api/desktop/app-settings', apiViews.DesktopAppSettingsAPIView.as_view()),
    path('api/desktop/topbar-counts', apiViews.DesktopTopbarCountsAPIView.as_view()),
    path('api/desktop/devices/register', apiViews.DesktopFcmDeviceAPIView.as_view()),
    path('api/desktop/devices/unregister', apiViews.DesktopFcmDeviceAPIView.as_view()),
    path('api/desktop/precart', apiViews.DesktopPrecartAPIView.as_view()),
    path('api/desktop/precart/checkout', apiViews.DesktopPrecartCheckoutAPIView.as_view()),
    path('api/desktop/precart/checkout-options', apiViews.DesktopPrecartCheckoutOptionsAPIView.as_view()),
    path('api/desktop/precart/items/<int:item_id>', apiViews.DesktopPrecartItemDetailAPIView.as_view()),
    ...
    path('api/preorders', apiViews.DesktopPreordersApiView.as_view()),
    path('api/preorders/<int:preorder_id>', apiViews.SuppliesInPreorderView.as_view()),
    path('api/desktop/deliveries/upload', apiViews.DesktopDeliveryUploadAPIView.as_view()),
    path('api/desktop/deliveries', apiViews.DesktopDeliveriesApiView.as_view()),
    path('api/desktop/deliveries/<int:delivery_id>', apiViews.DesktopDeliveryDetailApiView.as_view()),
    ...
    path('api/desktop/orders/<int:order_id>/np-form', apiViews.DesktopOrderNPFormAPIView.as_view()),
    path('api/desktop/orders/<int:order_id>/np-create', apiViews.DesktopOrderNPCreateAPIView.as_view()),
    path('api/desktop/clients', apiViews.DesktopClientsApiView.as_view()),
    path('api/desktop/clients/<int:place_id>/devices', apiViews.DesktopClientDevicesApiView.as_view()),
    path('api/desktop/devices', apiViews.DesktopDevicesApiView.as_view()),
    path('api/desktop/clients/<int:place_id>/service-notes', apiViews.DesktopClientServiceNotesApiView.as_view()),
    path('api/desktop/clients/<int:place_id>/booked-supplies', apiViews.DesktopClientBookedSuppliesApiView.as_view()),
    path('api/desktop/np-registers', apiViews.DesktopNpRegistersApiView.as_view()),
    path('api/desktop/np-uncompleted-orders', apiViews.DesktopNpUncompletedOrdersApiView.as_view()),
