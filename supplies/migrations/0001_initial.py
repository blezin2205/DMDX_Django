# Generated by Django 4.0.4 on 2022-08-30 06:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_code', models.PositiveIntegerField(blank=True, default=1, null=True)),
                ('ref_NP', models.CharField(blank=True, max_length=100, null=True)),
                ('address_NP', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='supplies.deliveryplace')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_place', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='workers', to='supplies.place')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='supplies.order')),
            ],
            options={
