...
web: gunicorn DMDX_Django.wsgi:application --bind 0.0.0.0:$PORT --worker-class gthread --workers 1 --threads 4 --timeout 20 --graceful-timeout 20 --max-requests 200 --max-requests-jitter 50 --worker-tmp-dir /dev/shm --log-file -